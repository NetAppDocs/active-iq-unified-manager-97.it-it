...
sidebar: sidebar 
keywords:  
summary: 'È possibile implementare l"appliance virtuale di Unified Manager dopo aver scaricato il file .ova dal NetApp Support Site. Per implementare l"appliance virtuale su un server ESXi, è necessario utilizzare vSphere Web Client (per vSphere versione 6.5 o 6.7) o vSphere Client (per vSphere versione 6.0). Quando si implementa l"appliance virtuale, viene creata una macchina virtuale.' 
---
...
[role="lead"]
È possibile implementare l'appliance virtuale di Unified Manager dopo aver scaricato `.ova` Dal sito di supporto NetApp. Per implementare l'appliance virtuale su un server ESXi, è necessario utilizzare vSphere Web Client (per vSphere versione 6.5 o 6.7) o vSphere Client (per vSphere versione 6.0). Quando si implementa l'appliance virtuale, viene creata una macchina virtuale.
