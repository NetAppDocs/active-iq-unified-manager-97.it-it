...
. Salvare la vista con un nome specifico che rifletta ciò che la vista mostra, ad esempio "`aggregates overcommit`" e fare clic sul segno di spunta (image:../media/blue-check.gif[""]).
