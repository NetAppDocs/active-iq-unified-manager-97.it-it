...
. Salvare la vista con un nome specifico che rifletta ciò che viene visualizzato, ad esempio "`aggregati quasi pieni`" e fare clic sul segno di spunta (image:../media/blue-check.gif[""]) .
