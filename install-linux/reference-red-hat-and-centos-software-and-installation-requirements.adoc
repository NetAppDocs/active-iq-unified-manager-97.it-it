...
* Red Hat Enterprise Linux o CentOS versione 7.x basato sull'architettura x86_64
...
* MySQL Community Edition versione 8.0.20 o successive nella famiglia 8.0 (dal repository MySQL)
+
[NOTE]
====
Assicurarsi di aver rimosso qualsiasi versione di MySQL 5.7 precedentemente installata. La versione di base di MySQL deve essere 8.0.20.
...
+
link:task-manually-configuring-the-epel-repository.html["Configurazione manuale del repository EPEL"]
