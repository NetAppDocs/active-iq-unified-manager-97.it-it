...
Utilizzato per abilitare l'accesso ai servizi API OnCommand Workflow Automation e OnCommand a Unified Manager.
 ...
 a| 
MySQL Database Extended Interface (il protocollo MySQL X)
 a| 
MySQL
 a| 
33060
...
[NOTE]
====
Le porte utilizzate per le comunicazioni HTTP e HTTPS (porte 80 e 443) possono essere modificate utilizzando la console di manutenzione di Unified Manager. Per ulteriori informazioni, vedere link:../config/concept-maintenance-console-menu.html["Menu della console di manutenzione"].
